...
public class Main {
    ...
    public void test() throws ModelException, ParserException, RoutingException, LogicException {
        ...
        DuelMenuController.getInstance().selectCard(Parser.cardAddressParser("hand", "1", false));
        ...
        DuelMenuController.getInstance().showHand();
        DuelMenuController.getInstance().selectCard(Parser.cardAddressParser("hand", "2", false));
        DuelMenuController.getInstance().goNextPhase();
        DuelMenuController.getInstance().showSelectedCard();
        DuelMenuController.getInstance().goNextPhase();
        DuelMenuController.getInstance().showHand();
        DuelMenuController.getInstance().goNextPhase();
        DuelMenuController.getInstance().goNextPhase();
        DuelMenuController.getInstance().selectCard(Parser.cardAddressParser("hand", "5", false));
        DuelMenuController.getInstance().summonCard();
        DuelMenuController.getInstance().showBoard();
        DuelMenuController.getInstance().goNextPhase();
        DuelMenuController.getInstance().selectCard(Parser.cardAddressParser("monster", "1", false));
